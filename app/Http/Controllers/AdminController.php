...
class AdminController extends Controller
{
    ...
    public function transactions()
    {
        ...
        $uniqueTransactions = Pesanan::select('kode_transaksi', DB::raw('MAX(id_pemesanan) as latest_id'))
        ...
        foreach ($uniqueTransactions as $trans) {
            ...
            $pesanan = Pesanan::where('kode_transaksi', $trans->kode_transaksi)
                ->with('pembayaran')
                ->get();
        ...
        return view('admin.riwayat-transaksi', compact('transactions'));
    }
    ...
    public function dashboard()
    {
        ...
        $totalReservasi = \App\Models\Pesanan::count();
        $totalTransaksi = Pesanan::whereIn('status', ['selesai', 'dikonfirmasi'])
            ->distinct()
    ...
    {
        try {
            $transaction = \App\Models\Pembayaran::with(['pemesanan.pelanggan'])
                ->findOrFail($id);
    ...
    {
        try {
            $transaction = \App\Models\Pembayaran::with('pemesanan')
                ->findOrFail($id);
    ...
    {
        try {
            $transaction = \App\Models\Pembayaran::findOrFail($id);
    ...
    {
        try {
            $pemesanan = Pesanan::where('kode_transaksi', $kode)->get();
    ...
    {
        try {
            $pemesanan = \App\Models\Pesanan::where('kode_transaksi', $kode)->get();
            ...
            foreach ($pemesanan as $p) {
                ...
                $meja = \App\Models\Meja::where('no_meja', $p->no_meja)->first();
                if ($meja) {
