            ...
            <div class="profile-card">
                ...
                <form action="{{ route('profile.update.password') }}" method="POST" class="space-y-3">
                    ...
                    <div class="form-control">
                        ...
                        <input type="password" name="password" class="input input-bordered input-sm" placeholder="Masukkan password baru" required />
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input type="password" name="password_confirmation" class="input input-bordered input-sm" placeholder="Konfirmasi password baru" required />
                    </div>
