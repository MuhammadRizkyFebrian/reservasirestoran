...
<section id="menu" class="py-8 sm:py-10 px-4 md:px-10">
    <div class="container mx-auto">
            ...
            <div class="card card-menu bg-base-200 shadow-xl overflow-hidden">
                ...
                <div class="card-body p-4 sm:p-6">
                    ...
                    <div class="card-actions justify-end mt-2">
                        <span class="badge badge-primary text-white text-xs sm:text-sm px-4 py-4 text-base">Rp{{ number_format($menu->harga, 0, ',', '.') }}</span>
                    </div>
                </div>
            </div>
            @empty
        ...
        <div class="text-center mt-6 sm:mt-8">
            <a href="{{ route('menu') }}" class="btn btn-primary text-white btn-sm sm:btn-md">Lihat lainnya...</a>
        </div>
    </div>
</section>
...
<section id="ulasan" class="py-8 sm:py-10 px-4 md:px-10 bg-base-200">
    <div class="container mx-auto">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8">
            ...
            <label for="modal-ulasan" class="btn btn-primary text-white mt-4 sm:mt-0">Tambah Ulasan</label>
            @else
            <a href="{{ route('login') }}" class="btn btn-primary text-white mt-4 sm:mt-0">Login untuk Menambah Ulasan</a>
            @endif
        </div>
            ...
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body p-4 sm:p-6">
                    ...
                    <div class="flex gap-2">
                        <!-- Tombol Edit -->
                        <button class="btn btn-sm btn-success edit-ulasan-btn"
                            data-id="{{ $review->id }}"
                            data-comments="{{ addslashes($review->comments) }}"
