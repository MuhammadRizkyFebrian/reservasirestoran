            ...
            <div class="card bg-base-100 shadow-md">
                <div class="card-body p-3">
                    ...
                    <div class="flex justify-between items-center border-b pb-2 mb-2">
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-base-content/70">Jl. Kuliner No. 123, Jakarta</p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="font-bold text-success text-sm">TERKONFIRMASI</p>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="receipt-border rounded-lg p-3 bg-base-200/50 mb-3">
                                <div class="flex justify-between items-center mb-1">
                                    <p class="font-bold text-base">RSV12345</p>
                                    <div class="badge badge-success">Terkonfirmasi</div>
                                </div>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                    <div>
                                        <p class="text-xs text-base-content/70 mb-0.5">Tanggal & Waktu</p>
                                        <p class="font-medium text-sm">Sabtu, 15 Juni 2024</p>
                                        <p class="font-medium text-sm">19:00 - 20:00 WIB</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-base-content/70 mb-0.5">Informasi Meja</p>
                                        <p class="font-medium text-sm">Meja VIP 01</p>
                                        <p class="text-xs">4 orang</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                <div class="bg-base-200/50 p-3 rounded-lg">
                                    ...
                                    <div class="detail-grid">
                                        ...
                                        <span class="value text-sm">John Doe</span>
                                        <span class="label">Kontak</span>
                                        <span class="value text-sm">+62 812-3456-7890</span>
                                    </div>
                                </div>
                                ...
                                <div class="bg-base-200/50 p-3 rounded-lg">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span class="text-sm font-bold">Rp 115.000</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-base-200/50 p-3 rounded-lg mt-3">
                                ...
                                <p class="text-xs">Mohon siapkan kursi anak. Lebih suka tempat yang tidak terlalu berisik.</p>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="bg-base-100 p-3 rounded-lg mb-3 text-center">
                                <div class="qr-border rounded-lg inline-block bg-white mb-1">
                                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=RSV12345" 
                    ...
                    <div class="text-center mt-3 text-xs">
                        <p class="font-medium">Terima kasih atas reservasi Anda!</p>
                        <p class="text-base-content/70">(021) 123-4567 • support@seatify.com</p>
                    </div>
                </div>
            </div>
        </div>
